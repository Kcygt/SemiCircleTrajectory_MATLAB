% Choose directory
rootdir = ['FCat_R0.050000/Flat_R0.050000_T%.6f_1',...
...
plot(0.5,mean(data.FC50.T10.Force(4800:5200,3)),'k*',0.55,mean(data.FC55.T10.Force(4800:5200,3)),'ko',0.6,mean(data.FC60.T10.Force(4800:5200,3)),'ks' ...
    ...
    ,0.5,mean(data.FC50.T3.Force(1300:1600,3)),'k*',0.55,mean(data.FC55.T3.Force(1300:1700,3)),'ko',0.6,mean(data.FC60.T3.Force(1300:1700,3)),'ks')
