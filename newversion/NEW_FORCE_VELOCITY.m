...
title('Velocity/Force for Radius=5cm Iteration=1')
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=5cm Iteration=2')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-0.8 -0.2])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=5cm Iteration=3')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-0.8 -0.2])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=5.5cm Iteration=1')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-1.2 -.4])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=5.5cm Iteration=2')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-1.2 -.4])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=5.5cm Iteration=3')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-1.2 -.4])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=6cm Iteration=1')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-3.8 -2.6])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=6cm Iteration=2')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-3.8 -2.6])
...
xlabel('Velocity in X axis')
ylabel('Force in Z axis')
title('Velocity/Force for Radius=6cm Iteration=3')
legend('T10','T8','T6','T4','T3')
xlim([-0.2 0.4])
ylim([-3.8 -2.6])
