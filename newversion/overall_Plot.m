...
ylabel("Friction Force (N)")
title("Low Penetration -  Friction Force")
g = [g1; g2; g3];
...
xlabel("Avarage Velocity(m/s)")
ylabel("Friction Force (N)")
title("Medium Penetration - Friction Force ")
g = [g1; g2; g3];
boxplot(x,g,'Notch','on','Labels',{'0.03','0.05','0.1'})
...
xlabel("Avarage Velocity(m/s)")
ylabel("Friction Force (N)")
title("High Penetration - Friction Force ")
g = [g1; g2; g3];
boxplot(x,g,'Notch','on','Labels',{'0.03','0.05','0.1'})
...
figure(8)
hold on; grid on;
x1 = -data1.FC50.T10.Force(2400:6500,3);
x2 = -data1.FC50.T6.Force(1600:3900,3);
x3 = -data1.FC50.T3.Force(1000:1800,3);
x = [x1;x2;x3];
...
figure(9)
hold on; grid on;
x1 = -data1.FC55.T10.Force(2400:6500,3);
x2 = -data1.FC55.T6.Force(1800:4000,3);
x3 = -data1.FC55.T3.Force(1100:1700,3);
x = [x1;x2;x3];
...
xlabel("Avarage Velocity(m/s)")
ylabel("Normal Force (N)")
title("Medium Penetration - Normal Force")
g = [g1; g2; g3];
boxplot(x,g,'Notch','on','Labels',{'0.03','0.05','0.1'})
...
figure(10)
hold on; grid on;
x1 = -data1.FC60.T10.Force(2000:4500,3);
x2 = -data1.FC60.T6.Force(1700:3300,3);
x3 = -data1.FC60.T3.Force(900:1300,3);
x = [x1;x2;x3];
...
xlabel("Avarage Velocity(m/s)")
ylabel("Normal Force (N)")
title("High Penetration - Normal Force")
g = [g1; g2; g3];
boxplot(x,g,'Notch','on','Labels',{'0.03','0.05','0.1'})
