...
% 
% filter_num = [0.1568 0.12689824 ];
% filter_den = [1 -1.25 0.5335];
% 
% system_transfer = tf(system_num,system_den,0.001);
% feedback_transfer = tf(feedback_num,feedback_den,0.001);
% filter_transfer = tf(filter_num,filter_den,0.001);
% 
% overall_system = system_transfer * feedback_transfer*filter_transfer;
