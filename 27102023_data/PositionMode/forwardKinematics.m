function [x, R] = forwardKinematics(q)
    q1 = q(1);
    q2 = q(2);
    q3 = q(3);
    q4 = q(4);
    ...
    x = [-0.0118 * x0 - 0.0128 * x11 + 0.3143 * x16 - 0.1674 * x19 - 0.0128 * x2 + 0.1674 * x26 + 0.4208 * x5 + 0.3143 * x7;
        -0.0128 * x14 - 0.4208 * x27 - 0.3143 * x28 + 0.0128 * x29 - 0.0118 * x3 + 0.3143 * x31 - 0.1674 * x33 + 0.1674 * x37;
        0.0128 * x38 + 0.3143 * x39 - 0.3143 * x41 - 0.1674 * x43 + 0.1674 * x46 + 0.4208 * x8 + 0.2848];
